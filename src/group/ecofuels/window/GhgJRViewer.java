...
public class GhgJRViewer extends Window implements EventListener<Event>, ITabOnCloseHandler {
	/**
	 *
	 */
	...
	private ToolBarButton bArchive = new ToolBarButton(); // Added by Andreas Sumerauer - Dipl. Ing. Wienold GmbH 21.11.2019
	private File attachment = null;
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(GhgJRViewer.class);
	...
	public GhgJRViewer(java.util.List<JasperPrint> jasperPrintList, ProcessInfo pi) {
		super();
		m_pi = pi;
		m_title = pi.getTitle();
		this.setTitle(m_title);
...
*/		
	...
	public void actionPerformed (Event e)
	{
		...
		if (e.getTarget() == previewType)
			...
			cmd_sendMail();
		else if (e.getTarget() == bArchive)  // Added by Andreas Sumerauer
			cmd_archive();
	}	//	actionPerformed
	...
	private void cmd_archive ()
	{
		...
		if (data != null)
		{
			FDialog.info(m_WindowNo, this, "ByteData created");
